# FourEver — App Store Connect metadata
...
The URLs become public after these files are pushed to the `fourever-privacy` repository and GitHub Pages is configured to deploy the root folder from the `main` branch.
